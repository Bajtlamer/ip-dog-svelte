...
<div class="items-center min-h-screen max-w-full p-2 mx-auto bg-gray-800 lg:p-20">
	<div
		class="max-w-screen-sm p-2 md:p-4 mx-auto bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-600 dark:border-gray-700"
	>
			...
			{#if server.subnets}
				{#each server.subnets as subnet, index}
					<li
						...
						id={index.toString()}
						class="py-3 pl-2 md:px-3 sm:py-4 bg-slate-700 border-gray-600 rounded-md"
					>
