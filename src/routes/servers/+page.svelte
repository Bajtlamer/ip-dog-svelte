...
<div class="items-center h-screen max-w-full p-2 mx-auto bg-gray-800 lg:p-20">
	<button on:click={() => (showModal = true)} class="hidden px-4 py-2 mr-3 text-sm font-medium text-center text-white bg-blue-700 rounded-md hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 md:mr-0 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 md:block">
		Add server 
	</button>
	<div
