                    ...
                    <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 14">
                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 6 6m0 0 6 6M7 7l6-6M7 7l-6 6"/>
                            ...
                            <div class="p-5 space-y-4">
                                <form action="/subnets?/edit_subnet" method="POST" class="space-y-4 md:space-y-6" use:enhance={submitDeviceForm}>
                                    <div class="relative z-0 w-full mb-6 group">
                                        <input
                                            ...
                                            placeholder={isEditMode()?device.address:'Enter an subnet name'}
                                            />
                                    ...
                                    {#if isEditMode()}
                                    <input type="hidden" bind:value={device.address} name="subnet" />
                                    <input type="hidden" bind:value={device.id} name="id" />
                                    <input type="hidden" bind:value={device.subnetId} name="serverId" />
                                    {/if}
                                    <div class="relative z-0 w-full mb-6 group">
