            ...
            <form action="/subnets?/edit_subnet" method="POST" class="space-y-4 md:space-y-6" use:enhance={submitSubnetForm}>
                ...
                <div class="relative z-0 w-full mb-6 group">
                    ...
                    <textarea
                        ...
                        rows="4"
                        class="block p-2.5 w-full text-sm font-normal text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Write an subnet description here..."
                        ></textarea>
                </div>
