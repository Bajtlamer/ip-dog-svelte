<script lang="ts">
	...
	import { getServerStatusIcon, getStatusIcon } from '$lib/functions.js';
	import { validateServer } from '$lib/proxy.js';
    export let server:ProxyServerInterface;
</script>

<div class="p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
    <h5 class="w-full flex justify-between items-center text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
        {server.name}
        <span class="pl-2">
    ...
    <span class="text-xs text-white mb-2 block">{server.hostname}</span>
